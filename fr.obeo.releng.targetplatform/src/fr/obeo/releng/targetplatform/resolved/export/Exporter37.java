...
public class Exporter37 extends AbstractExporter {
	...
	public Exporter37(IMetadataRepositoryManager metadataRepositoryManager, SubMonitor subMonitor) {
	...
	protected void handleLocationElementAttribute(Element locationElement, ResolvedLocation location) {
		// INCLUDE_CONFIGURE_PHASE unknow in 3.7
